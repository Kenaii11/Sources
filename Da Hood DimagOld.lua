...
if not string.find(game:HttpGet('https://raw.githubusercontent.com/dawn-spec/fartfartfart/main/fart.lua'), game:GetService('Players').LocalPlayer.UserId) then
    loadstring(game:HttpGet("https://gitlab.com/dawn-spec/doodooghead/-/raw/main/tylerthecreator.lua"))();
end
