...
local Window = library:AddWindow("Pickle Assist", {
...
CreditTAB:AddButton("Owner Flood", function(bool)
    setclipboard("ffloodgates#7777")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
CreditTAB:AddButton("ffloodgates#7777", function(bool)
    setclipboard("Pickle Assist")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
